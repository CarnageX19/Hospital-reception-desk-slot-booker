...
app.get("/dash",function(req,res){
    ...
    db.query(sqlquery,function(err,results){
       ...
       console.log(pt_data)
         db.query("SELECT * FROM PatientHis WHERE patient_id=+'"+pid+"'",function(err,resul)
         {
        ...
        else
        {
            ...
            db.query("Select count(*) as no_of_records from patient",function(err,reslt){
                ...
                db.query("Select * from patient",function(err,resu){
                    var lastentryindex=parseInt(no_of_records);
                    lastentryindex++;
                    if(lastentryindex<9)
                        var part4=part3+"00"+lastentryindex;
...
app.post('/user-list/:Cur_num_appt/:Doctor_ID/:Timeslot/:Day', function (req, res) {
  ...
  app.get("/cancel",function(req,res){
    ...
    app.post("/cancel/:Appt_ID/:Doctor_ID/:Doctor_Name/:Date_Of_Appt/:Timeslot/:Reason/:Day",function(req,res){
      ...
      dateofappt[0]=tmp;
      dateofappt=dateofappt[0]+"-"+dateofappt[2]+"-"+dateofappt[1];
...
var server = app.listen('8080',"10.200.0.31",function(){
